...
For detailed technical spec, agent architecture, and the 4-person role allocation guide, read:
👉 **[PROJECT_SPEC_AND_ROLES.md](./PROJECT_SPEC_AND_ROLES.md)**

---

## 🏆 Key Features & Hackathon Criteria Alignment
...
4. **4-Person Developer Team Split**: Modular agent division across Coordinator, Growth, Content, and Analytics/Demo leads.

---

## 👥 Team Roles Summary
* **Person 1 (Lead Architect)**: Coordinator Agent & Minds Memory Router
* **Person 2 (Growth Dev)**: Growth & Trend Discovery Agent
* **Person 3 (Content Dev)**: Multi-Platform Content Repurposing Agent
* **Person 4 (Analytics & Demo Lead)**: Persistence Feedback Engine & Video Demo Lead
