...
export const OverviewIcon: React.FC<IconProps> = ({ size = 18, className = "", color = "currentColor" }) => (
...
// 2. Coordinator Agent Icon
export const CoordinatorIcon: React.FC<IconProps> = ({ size = 18, className = "", color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 3. Growth & Trends Icon
export const GrowthIcon: React.FC<IconProps> = ({ size = 18, className = "", color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 3v18h18" />
...
// 4. Content Repurposing Icon
export const ContentIcon: React.FC<IconProps> = ({ size = 18, className = "", color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 7. X (Twitter) Official Vector Logo
...
// 8. LinkedIn Official Vector Logo
...
// 9. YouTube Shorts Official Vector Logo
